...
| Configuration Item     | Description                                                                                                                                                                                                                                                                                                                                                          | Current Value                                               |
|:-----------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------|
...
| update_interval        | Scheduled execution update interval in hours. Set 0 or empty to run only once, does not apply to workflow.                                                                                                                                                                                                                                                           | 12                                                          |
...
| time_zone              | Time zone used to control the time displayed for updates. Optional values: `Asia/Shanghai` or other time zone codes.                                                                                                                                                                                                                                                 | Asia/Shanghai                                               |
...
| logo_url               | Channel logo library URL.                                                                                                                                                                                                                                                                                                                                            | https://raw.githubusercontent.com/fanmingming/live/main/tv/ |
